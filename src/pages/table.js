...
import 'antd/dist/antd.css';
  ...
  class Tables extends Component {
    constructor(props) {
      ...
      this.columns = [
        ...
        },
        {
          ...
          key: 'address',
          input: [{text:''}],
          filters: [{input: 'text' ,   value: 'London No. 4 Lake Park'}, {text: 'DSK',    value: 'DSK'}],
          onFilter: (value, record) => record.name.indexOf(value) === 0,
    ...
    render() {
      ...
      return (
        //<div >search</span><input type="text" aria-invalid="false" class="jss279 jss264 jss284" value="" />
        <Table columns={columns} rowSelection={rowSelection} dataSource={dataSource} pagination={{ pageSize: 10 }} search={{}} />
